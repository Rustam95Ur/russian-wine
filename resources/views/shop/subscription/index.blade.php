                            ...
                            <div id="top_podpiska">
                                <div id="bannertitle">
                                    ...
                                    <div class="inner f26pl">
                                        <p class="mobileHidden">Как же порой трудно ориентироваться в мире вина, особенно Русского! Чтобы
                                          ...
                                          <p class="desktopHidden">Как же порой трудно ориентироваться в мире вина, особенно Русского! Чтобы
                                              облегчить Вам решение этой непростой задачи, мы сами отобрали лучшие вина и
                                              скомпоновали их в сеты.
                                          </p>
                                          <button type="button" class="btn btn-danger desktopHidden" name="button"><a href="#" class=" ">Оформить подписку</a></button>
                                    </div>
                                </div>
                            </div>
                            <div id="firstblock">
