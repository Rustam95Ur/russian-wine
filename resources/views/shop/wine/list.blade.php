...
@section('content')
    <div class="shopContent">
        ...
        <div class="row sortSearch">
            <div class="col-xs-6">
              <a class="mobileFilters" onclick="$('#filtMobi').addClass('open');$('.shopContent').addClass('hideMe');">
                  <img src="{{ asset ('image/filters.svg') }}" alt="" class="search-icon filtersIconsMobile">
                  <span class="mobileFiltersText">Фильтр</span>
              </a>
            </div>
            <div class="col-xs-6">
              <a class="mobileSorting" onclick="$('#sortMobi').addClass('open');$('.shopContent').addClass('hideMe');">
                ...
                <div class="panel-group">
                    <div class="panel panel-default">
                        ...
                        <button class="collapseBtn" id="btnCollapse-winery" name="button" data-toggle="collapse"
                                data-target="#collapse-winery-suboverlay" onclick="collapse_click('winery')" aria-expanded="false"
      ...
      <div id="filtMobi" class="col-xs-12 sortingMobile">
          <div class="sortingOverlay">
            <div class="sortOverlayHeader">
                <h3 class="sortHeader">
                  <a class="sortOverlayClear">
                    ...
                    Фильтр
                  <a href="#" class="sortOverlayBack" onclick="$('#filtMobi').removeClass('open');$('.shopContent').removeClass('hideMe');"><img src="{{ asset ('image/closecart.png') }}" alt="Close Overlay" class="sortOverlayClose">
                  </a>
                </h3>
            </div>
              ...
              <div class="OtherFilters">
                  <ul class="filtersSubOverlay">
                    ...
                    <div id="filtMobiColor" class="SubOverlay">
                      <div class="sortOverlayHeader">
                          <a href="#" class="sortOverlayBack" onclick="$('#filtMobiColor').removeClass('open');"><img src="{{ asset ('image/ArrowLeft.svg') }}" alt="Go back">Цвет</a>
                      </div>
                      <div class="sortOverlayBody">
                        @foreach($colors as $color)
                            <div class="form-check">
                      ...
                      <div class="sortSuboverlayFooter">
                    ...
                    <div id="filtMobiPrice" class="SubOverlay">
                      <div class="sortOverlayHeader">
                          <a href="#" class="sortOverlayBack" onclick="$('#filtMobiPrice').removeClass('open');"><img src="{{ asset ('image/ArrowLeft.svg') }}" alt="Go back">Цена</a>
                      </div>
                      <div class="sortOverlayBody">
                        <div class="form-check">
                            <input class="form-check-input" form="searching-form" name="price[]" type="checkbox" value="0-1000"
                    ...
                    <div id="filtMobiType" class="SubOverlay">
                      <div class="sortOverlayHeader">
                          <a href="#" class="sortOverlayBack" onclick="$('#filtMobiType').removeClass('open');"><img src="{{ asset ('image/ArrowLeft.svg') }}" alt="Go back">Тип Вина</a>
                      </div>
                      <div class="sortOverlayBody">
                        @foreach($sugars as $sugar)
                            <div class="form-check">
                    ...
                    <div id="filtMobiRegion" class="SubOverlay">
                      <div class="sortOverlayHeader">
                          <a href="#" class="sortOverlayBack" onclick="$('#filtMobiRegion').removeClass('open');"><img src="{{ asset ('image/ArrowLeft.svg') }}" alt="Go back">Регион</a>
                      </div>
                      <div class="sortOverlayBody">
                        @foreach($regions as $region)
                            <div class="form-check">
                    ...
                    <div id="filtMobiWinery" class="SubOverlay">
                      <div class="sortOverlayHeader">
                          <a href="#" class="sortOverlayBack" onclick="$('#filtMobiWinery').removeClass('open');"><img src="{{ asset ('image/ArrowLeft.svg') }}" alt="Go back">Регион</a>
                      </div>
                      <div class="sortOverlayBody">
                        <!--     wine winemaker filters                   -->
                    ...
                    <!--   collapse other prices   -->
                        <div class="panel-group">
                            <div class="panel panel-default">
                                ...
                                <button class="collapseBtn" id="btnCollapse-winery" name="button" data-toggle="collapse"
                                        data-target="#collapse-winery-suboverlay" onclick="collapse_click('winery-suboverlay')" aria-expanded="false"
                                        aria-controls="collapse-winery-suboverlay" type="button">
                                    <span>Посмотреть все</span>
                                    <img src="{{ asset ('image/arrow-down.svg') }}" alt="" class="collapseIcon">
                                </button>
                    ...
                    <div id="filtMobiSort" class="SubOverlay">
                      <div class="sortOverlayHeader">
                          <a href="#" class="sortOverlayBack" onclick="$('#filtMobiSort').removeClass('open');"><img src="{{ asset ('image/ArrowLeft.svg') }}" alt="Go back">Сорт винограда</a>
                      </div>
                      <div class="sortOverlayBody">
                              ...
                              <!--  filter live search end -->
                                ...
                                <!--   collapse other prices   -->
                                    <div class="panel-group">
                                      ...
                                      <button class="collapseBtn" id="btnCollapse-sort-overlay" name="button" data-toggle="collapse"
                                              data-target="#collapse-sort" onclick="collapse_click('sort-overlay')" aria-expanded="false"
                                              aria-controls="collapse-sort" type="button">
                                          <span>Посмотреть все</span>
                                          <img src="{{ asset ('image/arrow-down.svg') }}" alt="" class="collapseIcon">
                                      </button>
                    ...
                    <div id="filtMobiYear" class="SubOverlay">
                      <div class="sortOverlayHeader">
                          <a href="#" class="sortOverlayBack" onclick="$('#filtMobiYear').removeClass('open');"><img src="{{ asset ('image/ArrowLeft.svg') }}" alt="Go back">Год</a>
                      </div>
                      <div class="sortOverlayBody">
                        <!--     wine year filters                        -->
                          <form name="filter_form" method="get" class="filtersMain showME">
                    ...
                    <div id="filtMobiFort" class="SubOverlay">
                      <div class="sortOverlayHeader">
                          <a href="#" class="sortOverlayBack" onclick="$('#filtMobiFort').removeClass('open');"><img src="{{ asset ('image/ArrowLeft.svg') }}" alt="Go back">Крепость</a>
                      </div>
                      <div class="sortOverlayBody">
                        <!--     wine grad filters                        -->
                            <form name="filter_form" method="get" class="filtersMain">
                                ...
                                <div class="panel-group">
                                    <div class="panel panel-default">
                                        ...
                                        <!--  Collapse inner space end -->
                                            ...
                                            <button class="collapseBtn" id="btnCollapse-fortress-overlay" onclick="collapse_click('fortress-overlay')"
                                                name="button" data-toggle="collapse"
                                                data-target="#collapse-fortress" aria-expanded="false"
                                                aria-controls="collapse-fortress" type="button">
                                            <span>Посмотреть все</span>
            ...
            <div class="sortOverlayFooter">
                <button class="sortOverlayBtn">Показать</button>
            </div>
          </div>
      </div>
      <div id="sortMobi" class="col-xs-12 sortingMobile">
        <div class="sortingOverlay">
          <div class="sortOverlayHeader">
              <a href="#" class="sortOverlayBack" onclick="$('#sortMobi').removeClass('open');$('.shopContent').removeClass('hideMe');"><img src="{{ asset ('image/ArrowLeft.svg') }}" alt="Go back">Сортировка</a>
          </div>
          <div class="sortOverlayBody">
              <ul>
