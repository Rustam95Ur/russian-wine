{{ header }} 
<div class="normal_container" id="greek">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 col-xs-12 half_plus row-no-padding" style="position:relative;">
                    ...
                    <img src="image/{{ description_first_image }}" class="person_img abs_img">
                </div>
             </div>
          </div>
    </div>
            ...
            <div class="container" >
                <div class="row">
                    <div class="margin_box col-md-7 col-xs-12 half_minus row-no-padding" style="position:relative;">
                        ...
                        <img src="image/{{ description_second_image_two }}" id="second_ter_img"/>
                        <div class="text_s_s">
        ...
        <div class="container">
            <div class="row flex_elem">
                ...
                <div class="col-md-8 col-xs-12 half_minus row-no-padding">
                    ...
                    <img src="image/{{ description_third_image }}">
                </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 col-xs-12 row-no-padding half_plus">
                        <img src="image/{{ description_third_image_two }}" class="page_image" id="mrg_img">
                    </div>
            ...
            <div class="container">
                <div class="row flex_elem">
                    ...
                    <div class="col-md-8 col-xs-12 half_minus">
                        <img src="image/{{ description_fourth_image_three }}">
                    </div>
                </div>
            </div>
        </div>
