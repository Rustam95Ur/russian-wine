{{ header }} 
<div class="normal_container" id="romanov">
        ...
        <div class="background_grey">
            ...
            <div class="col-md-6 col_2 col-xs-12 text_pad">
                ...
                <div class="species_box">
                    <div class="cvet_sorta">
                        <h6 class="white">
                            Белые сорта
                        </h6>
                        {{ description_white_wines }}
                    </div>
                    <div class="cvet_sorta">
                        <h6 class="red">
                            Красные сорта
                        </h6>
                        {{ description_red_wines }}
                    </div>
                </div>
            </div>
    ...
    <div class="vinodelnia">
        ...
        <div class="container flex_elem">
            ...
            <div class="col-md-7 col_3 col-xs-12">
                 <img src="image/{{ description_fourth_image_three }}" class="float_img">
            </div>
