...
@push('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/winery.css') }}">
@endpush
@section('content')
                        ...
                        <div class="row mt-md mb-sm">
                            <div class="col-xs-8 col-xs-offset-2">
                                <div class="logo-wrap" style="background: transparent;">
                                    <img alt="logo_image" class="mt-mdlg mb-mdlg"
                    ...
                    @if ($block->numbering == 1 and $block->type_id == 0)
                        <div class="background-white">
                            <div class="container container-lg">
                                <div class="row">
                                    <div class="col-sm-6 col-md-5 description-first-image">
                        ...
                        @foreach($winery->images as $block)
                            @if ($block->numbering == 1 and $block->type_id == 2)
                                <div class="row flex_elem">
                                    ...
                                    <div class="col-lg-7 col_1 col-lg-offset-0 col-md-offset-4 col-md-8 flex_elem_row">
