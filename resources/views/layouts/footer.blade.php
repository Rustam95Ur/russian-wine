        ...
        <div class="row ">
            <div class="ftr__list nav col-sm-3 col-md-4 col-lg-3 col-lg-push-3">
                ...
                <ul class="list-unstyled">
                    <li><a href="/wineshop">Вино</a></li>
                    <li><a href="/sety/">Винные сеты</a></li>
            ...
            <div class="footer-contact col-sm-5 col-md-5 col-lg-3 col-lg-push-3">
                ...
                <div class="social"><a href="https://www.facebook.com"><img src="{{ asset ('image/iconFacebook.png') }}"></a> <a href="https://www.instagram.com"><img src="{{ asset ('image/iconInstagram.png') }}"></a></div>
            </div>
            <div class="footer-logo col-sm-12 col-md-12 col-lg-3 col-lg-pull-8">
                <h5><a href="/" id="footer_logo"><img src="{{ asset ('image/logo.svg') }}"></a></h5>
                <p class="about">
